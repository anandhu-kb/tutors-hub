    ...
    <main class="dashboard-main-wrapper">
        ...
        <div class="container">
            ...
            if(isset($_POST['upload']))
            {
                ...
                $tcs_id=$tcs['id'];
                $sql=mysqli_query($con,"INSERT INTO `notes`(`title`, `file`, `tutor_classes_subjects_id`,`t_id`) VALUES ('$title','$file','$tcs_id','$tid')");
            }
...
<table class="table">
  ...
  <tbody>
    <?php
        $f=mysqli_query($con,"SELECT * FROM `notes` WHERE `t_id`='$tid'");
    ...
    <tr>
      ...
      <td><a href="../<?php echo $row['file'] ?>">show</a></td>
      <td>delete</td>
    </tr>
    <?php } ?>
